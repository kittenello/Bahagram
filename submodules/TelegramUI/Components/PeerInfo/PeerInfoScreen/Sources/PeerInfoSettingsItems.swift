...
func settingsItems(data: PeerInfoScreenData?, context: AccountContext, presentationData: PresentationData, interaction: PeerInfoInteraction, isExpanded: Bool) -> [(AnyHashable, [PeerInfoScreenItem])] {
    ...
    items[.bahogram]!.append(PeerInfoScreenDisclosureItem(id: 0, text: "Настройки Bahagram", icon: PresentationResourcesSettings.bahogramOutlineIcon("gearshape", color: presentationData.theme.list.itemPrimaryTextColor), action: {
